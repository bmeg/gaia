...
def case_tree(args):
    ...
    # opts = lambda: None
    # opts.format = None
    # opts.type = "Gene Expression Quantification"

    # params = {
    #     'expand': ['cases','cases.samples'],
    #     'filters': build_conditions(opts)
    # }

    # for case in gdc_paginate(FILES, params=params):
    #     id = case['submitter_id']
    #     # tree[id] = {
    #     #     'samples': [
    #     #         'files':
    #     #     ]
